...
namespace PluginFileReader.API.Factory.Implementations.AS400
{
    ...
    {
        public static List<Format> Format25 = new List<Format>
        {
            new Format
            {
            ...
            new Format
            {
                ...
                Columns = new List<Column>
                {
                    ...
                    new Column
                    {
                        IsKey = false,
                        TrimWhitespace = true,
                        ColumnName = "Number of Autos on Policy",
                        ColumnStart = 26,
                        ColumnEnd = 28
                    },
                    new Column
                    {
                        IsKey = false,
                        TrimWhitespace = true,
                        ColumnName = "Number of Autos (California)",
                        ColumnStart = 29,
                        ColumnEnd = 31
                    },
                    new Column
